...
st.set_page_config(page_title='Prediction of Disease Outbreaks',
                   layout='wide',
                   page_icon="🧑‍⚕️")
diabetes_model = pickle.load(open(r"C:\Users\Windows\Downloads\Prediction-of-Disease-main\training_models\diabetes_models.sav", 'rb'))
heart_disease_model = pickle.load(open(r"C:\Users\Windows\Downloads\Prediction-of-Disease-main\training_models\best_heart_disease_model.sav", 'rb'))
parkinsons_model = pickle.load(open(r"C:\Users\Windows\Downloads\Prediction-of-Disease-main\training_models\parkinson_models.sav", 'rb'))
with st.sidebar:
